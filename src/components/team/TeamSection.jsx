...
const teamData = [
  {
    imgSrc: "/img/team/5a.png", // Replace with actual image path
  ...
  {
    imgSrc: "/img/team/4a.png", // Replace with actual image path
  ...
  {
    imgSrc: "/img/team/6a.png", // Replace with actual image path
    name: "Mr. Mouleesh K",
