...
export const Card = ({ className, children }) => {
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full flex p-4 overflow-hidden bg-textColor border border-transparent dark:border-white/[0.2] group-hover:border-slate-700 relative z-20",
        className
      )}
    >
...
export const CardTitle = ({ className, children }) => {
  return (
    <h4
      className={cn(
        "text-[#ffc541] font-bold tracking-wide mt-4 text-xl text-center",
        className
      )}
    >
      {children}
...
export const CardDescription = ({ className, children }) => {
  return (
    <p
      className={cn(
        "mt-8 text-gray-100 tracking-wide leading-relaxed text-md",
        className
      )}
    >
      {children}
